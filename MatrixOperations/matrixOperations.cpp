...
class MatrixClass { // this is the matrix class
...
MatrixClass createClassMatrix(int rows, int cols) { // this function creates a matrix with the specified number of rows and columns
    MatrixClass matrix; // this creates a matrix
    matrix.rows = rows; // this sets the number of rows
    matrix.cols = cols; // this sets the number of columns
    matrix.matrix = new int*[rows]; // this creates an array of pointers
    for (int i = 0; i < rows; i++) { // this loops through the rows
...
void printClassMatrix(MatrixClass matrix) { // this function prints the matrix
    for (int i = 0; i < matrix.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix.cols; j++) { // this loops through the columns
            cout << matrix.matrix[i][j] << " "; // this prints the element
        }
...
MatrixClass addClassMatrices(MatrixClass matrix1, MatrixClass matrix2) { // this function adds two matrices
    MatrixClass result = createClassMatrix(matrix1.rows, matrix1.cols); // this creates a matrix with all elements equal to 0
    for (int i = 0; i < matrix1.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix1.cols; j++) { // this loops through the columns
            result.matrix[i][j] = matrix1.matrix[i][j] + matrix2.matrix[i][j]; // this adds the elements
        }
...
MatrixClass subtractClassMatrices(MatrixClass matrix1, MatrixClass matrix2) { // this function subtracts two matrices
    MatrixClass result = createClassMatrix(matrix1.rows, matrix1.cols); // this creates a matrix with all elements equal to 0
    for (int i = 0; i < matrix1.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix1.cols; j++) { // this loops through the columns
            result.matrix[i][j] = matrix1.matrix[i][j] - matrix2.matrix[i][j]; // this subtracts the elements
...
// we will create the mainClass function

int mainClass() { // this is the main function
    MatrixClass matrix1 = createClassMatrix(2, 2); // this creates the first matrix
    matrix1.matrix[0][0] = 1; // this sets the element
    matrix1.matrix[0][1] = 2; // this sets the element
    matrix1.matrix[1][0] = 3; // this sets the element
    matrix1.matrix[1][1] = 4; // this sets the element
    MatrixClass matrix2 = createClassMatrix(2, 2); // this creates the second matrix
    matrix2.matrix[0][0] = 5; // this sets the element
    matrix2.matrix[0][1] = 6; // this sets the element
    matrix2.matrix[1][0] = 7; // this sets the element
    matrix2.matrix[1][1] = 8; // this sets the element
    cout << "Matrix 1:" << endl; // this prints a message
    printClassMatrix(matrix1); // this prints the first matrix
    cout << "Matrix 2:" << endl; // this prints a message
    printClassMatrix(matrix2); // this prints the second matrix
    cout << "Result of adding the matrices:" << endl; // this prints a message
    MatrixClass result = addClassMatrices(matrix1, matrix2); // this adds the matrices
    printClassMatrix(result); // this prints the result
    cout << "Result of subtracting the matrices:" << endl; // this prints a message
    result = subtractClassMatrices(matrix1, matrix2); // this subtracts the matrices
    printClassMatrix(result); // this prints the result
    return 0; // this returns 0
}

// we will create a template for the matrix

template <typename T> // this is the template for the matrix
class MatrixTemplate { // this is the matrix class
public: // change the access specifier to public
    // let's suppose that we have a matrix with integers
    // using something other than vectors
    int rows; // this is the number of rows
    int cols; // this is the number of columns
    T **matrix; // this is the matrix
};

template <typename T> // this is the template for the matrix
MatrixTemplate<T> createTemplateMatrix(int rows, int cols) { // this function creates a matrix with the specified number of rows and columns
    MatrixTemplate<T> matrix; // this creates a matrix
    matrix.rows = rows; // this sets the number of rows
    matrix.cols = cols; // this sets the number of columns
    matrix.matrix = new T*[rows]; // this creates an array of pointers
    for (int i = 0; i < rows; i++) { // this loops through the rows
        matrix.matrix[i] = new T[cols]; // this creates an array
        for (int j = 0; j < cols; j++) { // this loops through the columns
            matrix.matrix[i][j] = 0; // this sets the element
        }
    }
...
template <typename T> // this is the template for the matrix
void printTemplateMatrix(MatrixTemplate<T> matrix) { // this function prints the matrix
    for (int i = 0; i < matrix.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix.cols; j++) { // this loops through the columns
            cout << matrix.matrix[i][j] << " "; // this prints the element
        }
...
template <typename T> // this is the template for the matrix
MatrixTemplate<T> addTemplateMatrices(MatrixTemplate<T> matrix1, MatrixTemplate<T> matrix2) { // this function adds two matrices
    MatrixTemplate<T> result = createTemplateMatrix<T>(matrix1.rows, matrix1.cols); // this creates a matrix with all elements equal to 0
    for (int i = 0; i < matrix1.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix1.cols; j++) { // this loops through the columns
            result.matrix[i][j] = matrix1.matrix[i][j] + matrix2.matrix[i][j]; // this adds the elements
        }
...
template <typename T> // this is the template for the matrix
MatrixTemplate<T> subtractTemplateMatrices(MatrixTemplate<T> matrix1, MatrixTemplate<T> matrix2) { // this function subtracts two matrices
    MatrixTemplate<T> result = createTemplateMatrix<T>(matrix1.rows, matrix1.cols); // this creates a matrix with all elements equal to 0
    for (int i = 0; i < matrix1.rows; i++) { // this loops through the rows
        for (int j = 0; j < matrix1.cols; j++) { // this loops through the columns
            result.matrix[i][j] = matrix1.matrix[i][j] - matrix2.matrix[i][j]; // this subtracts the elements
...
// we will create the mainTemplate function

template <typename T> // this is the template for the matrix
int mainTemplate() { // this is the main function
    MatrixTemplate<T> matrix1 = createTemplateMatrix<T>(2, 2); // this creates the first matrix
    matrix1.matrix[0][0] = 1; // this sets the element
    matrix1.matrix[0][1] = 2; // this sets the element
    matrix1.matrix[1][0] = 3; // this sets the element
    matrix1.matrix[1][1] = 4; // this sets the element
    MatrixTemplate<T> matrix2 = createTemplateMatrix<T>(2, 2); // this creates the second matrix
    matrix2.matrix[0][0] = 5; // this sets the element
    matrix2.matrix[0][1] = 6; // this sets the element
    matrix2.matrix[1][0] = 7; // this sets the element
    matrix2.matrix[1][1] = 8; // this sets the element
    cout << "Matrix 1:" << endl; // this prints a message
    printTemplateMatrix(matrix1); // this prints the first matrix
    cout << "Matrix 2:" << endl; // this prints a message
    printTemplateMatrix(matrix2); // this prints the second matrix
    cout << "Result of adding the matrices:" << endl; // this prints a message
    MatrixTemplate<T> result = addTemplateMatrices(matrix1, matrix2); // this adds the matrices
    printTemplateMatrix(result); // this prints the result
    cout << "Result of subtracting the matrices:" << endl; // this prints a message
    result = subtractTemplateMatrices(matrix1, matrix2); // this subtracts the matrices
    printTemplateMatrix(result); // this prints the result
    return 0; // this returns 0
}

// we will create the main function
...
int main() { // this is the main function
    ...
    cout << endl << "Output of class matrix operations:" << endl;
    mainClass(); // this calls the mainClass function
    cout << endl << "Output of template matrix operations:" << endl;
    mainTemplate<int>(); // this calls the mainTemplate function
    return 0; // this returns 0
}
